...
if rangekf == 2:
	...
	alpha = 666.7   # high kf
	beta = 0.3478
	uo = np.array([.0468627,.89870,.846515]); #u1 = np.array([.0468627,.89870,.846525])
...
if plotattractor == 1:
	...
	axes(color=(1.,0.,0.),extent=[min(np.log10(results[:,0])),max(np.log10(results[:,0])),min(np.log10(results[:,1])),max(np.log10(results[:,1])),min(np.log10(results[:,2])),max(np.log10(results[:,2]))],ranges=[min(np.log10(results[:,0])),max(np.log10(results[:,0])),min(np.log10(results[:,1])),max(np.log10(results[:,1])),min(np.log10(results[:,2])),max(np.log10(results[:,2]))]); #axes(color=(1.,0.,0.),extent=[min(np.log10(results1[:,0])),max(np.log10(results1[:,0])),min(np.log10(results1[:,1])),max(np.log10(results1[:,1])),min(np.log10(results1[:,2])),max(np.log10(results1[:,2]))],ranges=[min(np.log10(results1[:,0])),max(np.log10(results1[:,0])),min(np.log10(results1[:,1])),max(np.log10(results1[:,1])),min(np.log10(results1[:,2])),max(np.log10(results1[:,2]))])
